...
Usage:
    python scripts/plot_combined_ode_comparison.py \
...
VARIANTS = {
    ...
    "euler_cfg45_cfg45": {
        "path": "/home/work/.local/ode_analysis/14B/euler_cfg45_cfg45/metrics.csv",
        "label": "Euler: CFG→CFG",
        "color": "tab:blue",
        "linestyle": "-",
        "linewidth": 1.5,
    ...
    "euler_nocfg_cfg45": {
        "path": "/home/work/.local/ode_analysis/14B/euler_nocfg_cfg45/metrics.csv",
    ...
    "euler_nocfg_nocfg": {
        "path": "/home/work/.local/ode_analysis/14B/euler_nocfg_nocfg/metrics.csv",
