#!/bin/bash
# Generate full ODE trajectories (with audio) for analysis.
#
# Usage:
#   bash scripts/omniavatar/generate_ode_trajectories.sh              # 14B (default)
#   bash scripts/omniavatar/generate_ode_trajectories.sh 1.3B          # 1.3B
set -euo pipefail
