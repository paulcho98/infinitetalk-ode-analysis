...
VARIANTS = {
    "trajectory": {
        "path": "latentsync_1.6/perceptual_v2/metrics.csv",
    ...
    "trajectory_nocfg": {
        "path": "latentsync_1.6/trajectory_nocfg/metrics.csv",
    ...
    "euler_cfg15_cfg15": {
        "path": "latentsync_1.6/euler_cfg15_cfg15/metrics.csv",
        "label": "Euler: CFG→CFG",
        "color": "tab:blue",
        "linestyle": "-",
        "linewidth": 1.5,
    ...
    "euler_nocfg_cfg15": {
        "path": "latentsync_1.6/euler_nocfg_cfg15/metrics.csv",
    ...
    "euler_nocfg_nocfg": {
        "path": "latentsync_1.6/euler_nocfg_nocfg/metrics.csv",
...
TRAJ_DIR = os.environ.get("ODE_TRAJ_ROOT_OMNI", "/home/work/.local/ode_full_trajectories") + "/latentsync_1.6"
