...
MODELS = {
    "omni_original": {
        "csv_cfg":   "14B/perceptual_v2/metrics.csv",
        "csv_nocfg": "14B/trajectory_nocfg/metrics.csv",
        "label_cfg":   "OmniAvatar CFG=4.5 (text+audio)",
        "label_nocfg": "OmniAvatar noCFG",
        "color": "tab:blue",
    },
    "omni_audio_only": {
        "csv_cfg":   "14B_audio_only_cfg/perceptual_v2/metrics.csv",
        "csv_nocfg": "14B/trajectory_nocfg/metrics.csv",
    ...
    "latentsync": {
        "csv_cfg":   "latentsync_1.6/perceptual_v2/metrics.csv",
        "csv_nocfg": "latentsync_1.6/trajectory_nocfg/metrics.csv",
...
def main():
    ...
    for m in MODELS.values():
        m["csv_cfg"] = os.path.join(args.analysis_root, m["csv_cfg"])
        m["csv_nocfg"] = os.path.join(args.analysis_root, m["csv_nocfg"])
