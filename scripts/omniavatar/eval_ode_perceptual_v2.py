...
Usage:
    # Decode all (4 GPUs)
    bash scripts/omniavatar/run_eval_ode_perceptual_v2.sh

    # Or manually:
    CUDA_VISIBLE_DEVICES=0 python scripts/omniavatar/eval_ode_perceptual_v2.py \
        --phase decode \
    ...
    python scripts/omniavatar/eval_ode_perceptual_v2.py --merge \
        --traj_dir /home/work/.local/ode_full_trajectories/14B \
        --output_dir /home/work/.local/ode_analysis/14B/perceptual_v2
"""
